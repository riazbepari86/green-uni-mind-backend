...
const generalAnalyticsRateLimit = (0, express_rate_limit_1.default)({
    windowMs: 60 * 1000, // 1 minute
...
router.get('/teachers/:teacherId/overview', generalAnalyticsRateLimit, // Apply general rate limit
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getTeacherAnalytics), analytics_controller_1.AnalyticsController.getTeacherAnalytics);
router.get('/teachers/:teacherId/dashboard', dashboardRateLimit, // Higher limit for dashboard endpoint
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getDashboardSummary), analytics_controller_1.AnalyticsController.getDashboardSummary);
router.get('/teachers/:teacherId/export', generalAnalyticsRateLimit, // Apply general rate limit
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.exportAnalytics), analytics_controller_1.AnalyticsController.exportAnalytics);
// Course Analytics Routes
router.get('/teachers/:teacherId/courses/:courseId', generalAnalyticsRateLimit, // Apply general rate limit
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getCourseAnalytics), analytics_controller_1.AnalyticsController.getCourseAnalytics);
// Revenue Analytics Routes
router.get('/teachers/:teacherId/revenue', generalAnalyticsRateLimit, // Apply general rate limit
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getRevenueAnalytics), analytics_controller_1.AnalyticsController.getRevenueAnalytics);
// Performance Metrics Routes
router.get('/teachers/:teacherId/performance', generalAnalyticsRateLimit, // Apply general rate limit
(0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getPerformanceMetrics), analytics_controller_1.AnalyticsController.getPerformanceMetrics);
...
router.get('/teachers/:teacherId/student-engagement', generalAnalyticsRateLimit, (0, auth_1.default)(user_constant_1.USER_ROLE.teacher), (0, validateRequest_1.default)(analytics_validation_1.AnalyticsValidation.getStudentEngagementDetails), analytics_controller_1.AnalyticsController.getStudentEngagementDetails);
...
router.get('/students/:studentId/dashboard', generalAnalyticsRateLimit, (0, auth_1.default)(user_constant_1.USER_ROLE.student), analytics_controller_1.AnalyticsController.getStudentDashboard);
