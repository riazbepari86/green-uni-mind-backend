...
router.get('/teachers/:teacherId', (0, auth_1.default)(user_constant_1.USER_ROLE.teacher, user_constant_1.USER_ROLE.student, user_constant_1.USER_ROLE.user), user_controller_1.UserControllers.getTeacherProfile);
router.get('/students/:studentId', (0, auth_1.default)(user_constant_1.USER_ROLE.teacher, user_constant_1.USER_ROLE.student, user_constant_1.USER_ROLE.user), user_controller_1.UserControllers.getStudentProfile);
